...
namespace ProgressIndicatorTest
{
    public partial class MainForm : Form
    {
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            ...
            radioButtonCW.Checked = progressIndicator.Rotation == RotationType.Clockwise;
        ...
        {
            progressIndicator.Rotation = radioButtonCW.Checked ? RotationType.Clockwise : RotationType.CounterClockwise;
        }
    }
}
